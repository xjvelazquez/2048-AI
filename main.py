...
if __name__ == '__main__':
    if args.test == 1:
        ...
        for seed in range(40, 50): #TODO: Seeds to use. start inclusive, end exclusive
            random.seed(seed)
            game = Game()
        ...
        test(f'seed_{start_seed}_to_{end_seed}_states.txt', f'seed_{start_seed}_to_{end_seed}_sols.txt')
    else:
        import pygame
